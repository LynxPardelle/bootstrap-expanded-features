    ...
    for (let bfe of bfes) {
      ...
      switch (bfeSplited[1]) {
        ...
        case "fs":
          ...
          break;
        case "lh":
          bfeStringed += `{line-height:${value};}`;
          break;
        case "gap":
          bfeStringed += `{gap:${value};}`;
          break;
        case "p":
      ...
      if (
        (bfeSplited[1] === "bg" ||
          ...
          bfeSplited[1] === "btn" ||
          bfeSplited[1] === "boxShadow" ||
          bfeSplited[1] === "textShadow") &&
        ...
        switch (bfeSplited[1]) {
          ...
          case "link":
            if (value.includes(" OPA")) {
              bfeStringed = `.${bfe} a{color: rgba(${await HexToRGB(
                colors[value.split(" ")[0]]
              ).toString()}, ${value.split(" ")[2]}) !important;}`;
            } else {
              bfeStringed = `.${bfe} a{color:${colors[value]} !important;}`;
            }
            break;
          case "borderColor":
            if (value.includes(" OPA")) {
          ...
          case "boxShadow":
            ...
            bfeStringed += `{box-shadow:${value} !important;}`;
            break;
          case "textShadow":
            for (let splitVal of value.split(" ")) {
              if (colorsNames.includes(splitVal)) {
            ...
            bfeStringed += `{text-shadow:${value} !important;}`;
            break;
        }
      }
      if (bfeStringed.includes("{") && bfeStringed.includes("}")) {
        if (hasBP === true) {
          bfeStringed = bfeStringed.replace(/\//g, "");
          switch (bfeSplited[2]) {
            case "sm":
