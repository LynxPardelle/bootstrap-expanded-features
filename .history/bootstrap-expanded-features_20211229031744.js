    ...
    if (
      ...
      switch (bfeSplited[1]) {
        ...
        case "btn":
          ...
          console.log(await darken(await HexToRGB(colors[value]), -15));
          console.log(await darken(await HexToRGB(colors[value]), -110));
          console.log(await darken(await HexToRGB(colors[value]), -115));
          console.log(await darken(await HexToRGB(colors[value]), -120));
          console.log(await darken(await HexToRGB(colors[value]), -125));
          console.log(await darken(await HexToRGB(colors[value]), -130));
