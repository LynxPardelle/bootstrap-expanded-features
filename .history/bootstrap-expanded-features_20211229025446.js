    ...
    if (
      ...
      switch (bfeSplited[1]) {
        ...
        case "btn":
          ...
          /.${bfe}:hover{background-color:${await darken(await HexToRGB(colors[value]), 20)};border-color:${await darken(await HexToRGB(colors[value]), 20)}
          /.btn-check:focus + .${bfe}, .${bfe}:focus{background-color:${colors[value]};border-color:${colors[value]}
          /.btn-check:checked + .${bfe}, .btn-check:active + .${bfe}, .${bfe}:active, .${bfe}.active, .show > .${bfe}.dropdown-toggle{background-color:${colors[value]};border-color:${colors[value]}
          /.btn-check:checked + .btn-check:focus, .btn-check:active + .${bfe}:focus, .${bfe}:active:focus, .${bfe}.active:focus, .show > .${bfe}.dropdown-toggle:focus{background-color:${colors[value]};border-color:${colors[value]}`;
          break;
      }
    }
