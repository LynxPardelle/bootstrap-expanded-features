    ...
    if (
      ...
      switch (bfeSplited[1]) {
        ...
        case "btn":
          ...
          console.log(await darken(await HexToRGB(colors[value]), 50));
          console.log(await darken(await HexToRGB(colors[value]), 60));
          console.log(await darken(await HexToRGB(colors[value]), 70));
          console.log(await darken(await HexToRGB(colors[value]), 80));
          console.log(await darken(await HexToRGB(colors[value]), 90));
          console.log(await darken(await HexToRGB(colors[value]), 100));
