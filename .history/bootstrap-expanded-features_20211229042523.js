...
function shadeTintColor(rgb, percent) {
  console.log(rgb);
  var R = rgb[0] === 0 && percent > 0 ? 16 : rgb[0] === 255 && percent < 0 ? 250 : rgb[0];
  var G = rgb[1] === 0 && percent > 0 ? 16 : rgb[1] === 255 && percent < 0 ? 250 : rgb[1];
  var B = rgb[2] === 0 && percent > 0 ? 16 : rgb[2] === 255 && percent < 0 ? 250 : rgb[2];
