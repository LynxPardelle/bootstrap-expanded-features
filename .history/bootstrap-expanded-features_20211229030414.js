    ...
    if (
      ...
      switch (bfeSplited[1]) {
        ...
        case "btn":
          ...
          console.log(await lighten(await HexToRGB(colors[value]), 50));
          console.log(await lighten(await HexToRGB(colors[value]), 60));
          console.log(await lighten(await HexToRGB(colors[value]), 70));
          console.log(await lighten(await HexToRGB(colors[value]), 80));
          console.log(await lighten(await HexToRGB(colors[value]), 90));
          console.log(await lighten(await HexToRGB(colors[value]), 100));
          bfeStringed += `{background-color:${colors[value]};border-color:${colors[value]};}
          /.${bfe}:hover{background-color:${await darken(await HexToRGB(colors[value]), 50)};border-color:${await darken(await HexToRGB(colors[value]), 60)}
