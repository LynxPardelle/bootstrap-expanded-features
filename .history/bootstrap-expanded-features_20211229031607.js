    ...
    if (
      ...
      switch (bfeSplited[1]) {
        ...
        case "btn":
          ...
          console.log(await darken(await HexToRGB(colors[value]), -10));
          console.log(await darken(await HexToRGB(colors[value]), -15));
          console.log(await darken(await HexToRGB(colors[value]), -20));
          console.log(await darken(await HexToRGB(colors[value]), -25));
          console.log(await darken(await HexToRGB(colors[value]), -30));
